...
2. [Why Use This Setup?](#why-use-this-setup)
   ...
   - [Grafana](#grafana)
3. [Network and Container Setup](#network-and-container-setup)
   - [Create a Network](#create-a-network)
4. [Zookeeper Container](#zookeeper-container)
5. [Kafka Brokers](#kafka-brokers)
   - [Kafka1 Broker](#kafka1-broker)
   - [Kafka2 Broker](#kafka2-broker)
6. [Producing and Consuming Messages](#producing-and-consuming-messages)
   - [Producer on Kafka2](#producer-on-kafka2)
   - [Consumer on Kafka1](#consumer-on-kafka1)
